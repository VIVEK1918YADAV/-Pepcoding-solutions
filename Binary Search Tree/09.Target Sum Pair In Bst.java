...
public class Main {
  ...
  public static void approach2(Node root, int target){
      ArrayList<Integer> arr = new ArrayList<>();//o(n)
      inorder(root, arr);//insert element in sorted order in arraylist - o(n)
  ...
  //Time - o(n*n)  space - o(h)=> constant(recursion space)
  ...
  public static void main(String[] args) throws Exception {
    ...
    //approach2(root, data);
    approach1Helper(root, data, root);
  }
